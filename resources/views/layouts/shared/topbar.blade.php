    ...
    -->
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ asset('images/icon/favicon.png') }}" alt="user-image" class="rounded-circle">
    ...
    <!--
        ...
        <div class="logo-box">
            <a href="{{route('admin')}}" class="logo logo-dark text-center">
                <span class="logo-sm">
                    <img alt="" src="{{ asset('images/logo-white.png') }}" height="22">
            ...
            <a href="{{route('admin')}}" class="logo logo-light text-center">
                <span class="logo-sm">
                    <img alt="" src="{{ asset('images/logo-white.png') }}" height="22">
                    <img src="{{asset('img/logoarauco.png')}}"alt="" height="22">
                </span>
                <span class="logo-lg">
                    <img alt="" src="{{ asset('images/logo-white.png') }}" height="22">
                </span>
