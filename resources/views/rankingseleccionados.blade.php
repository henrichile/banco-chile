...
@section('content')
                        ...
                        <table id="listadosel" class="table table-borderless table-hover table-nowrap table-centered m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if( $rol=="admin")
                                        <a href="javascript:void(0)" onclick="javascript:preclasificar({{ $item->id }}, {{ $zona}})" class="btn btn-xs btn-success">Pre-Clasificar</a>
                                        @endif
                                    </td>
    ...
    <form id="formclasificar" action="{{ route('preclasificar') }}" method="POST">
        @csrf
