                        ...
                        <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" onclick="javascript:clasificar({{ $item->id }})" class="btn btn-xs btn-success">Pre-seleccionar</a>
                                    </td>
                                    <td>
                                        <a  href="javascript:void(0)" onclick="javascript:descalificar({{ $item->id }})"  class="btn btn-xs btn-danger">Rechazar</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
...
<form id="formclasificar" action="{{ route('preseleccionar') }}" method="POST">
    @csrf
   <input type="hidden" name="idArtista" id="idArtista">
</form>

<form id="formdescalificar" action="{{ route('descalificar') }}" method="POST">
    @csrf
