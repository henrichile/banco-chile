                        ...
                        <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('ficha',['idArtista'=>$item->id])); ?>" class="btn btn-xs btn-light">Ficha de Registro</a>
                                    </td>
                                    <td>
                                        <a href="<?php echo e(route('preclasificar',['idArtista'=>$item->id])); ?>" class="btn btn-xs btn-success">Pre-seleccionar</a>
                                    </td>
                                    <td>
                                        <a href="<?php echo e(route('descalificar',['idArtista'=>$item->id])); ?>" class="btn btn-xs btn-danger">Rechazar</a>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Usuarios'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banco/public_html/banco/resources/views/descalificados.blade.php ENDPATH**/ ?>