...
unset($__errorArgs, $__bag); ?>" data-style="btn-light"  onchange="javascript:selsede()">
                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemrol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <option value="<?php echo e($itemrol->name); ?>" ><?php echo e($itemrol->description); ?></option>
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Nuevo usuario'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banco/public_html/banco/resources/views/administradorNuevo.blade.php ENDPATH**/ ?>