            ...
            <div class="auth-fluid-form-box">
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">      
                        ...
                        <div class="auth-brand text-center text-lg-left">
                            <div class="auth-logo">
                                <a href="<?php echo e(route('login')); ?>" class="logo logo-dark text-center">
                                    <span class="logo-lg">
                                        <img src="<?php echo e(asset('img/logoarauco.png')); ?>" alt="" width="60%">
                                    </span>
                                </a>
                        ...
                        <!-- title-->
                        <h4 class="mt-0">Ingreso de invitados <strong>SUMMIT TI</strong> Arauco</h4>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <label for="email"><?php echo e($lenguaje); ?></label>
                                <select name="lang" id="lang" class="form-control">
                                    <option value="es" <?php if($idioma=="es"): ?> selected="selected" <?php endif; ?>><?php echo e($lesp); ?></option>
                                    <option value="en" <?php if($idioma=="en"): ?> selected="selected" <?php endif; ?>><?php echo e($ling); ?></option>
                                    <option value="pt" <?php if($idioma=="pt"): ?> selected="selected" <?php endif; ?>><?php echo e($lport); ?></option>
                                </select>
                                <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
</html><?php /**PATH /home/invitado/public_html/invitados/resources/views/auth/login.blade.php ENDPATH**/ ?>