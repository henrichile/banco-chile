                    ...
                    <div class="container navigation-menu">
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-8 col-xs-3 position-inherit">
                                ...
                                <li class="nav-button propClone float-left btn-medium sm-no-margin-tb"><a href="<?php echo e(route('login')); ?>" class="inner-link sm-text-medium display-block sm-padding-nav-btn width-100 sm-display-inline-block sm-width-auto">INGRESAR</a></li>
                        <?php else: ?>
                    ...
                    <div class="row equalize">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 xs-text-center xs-margin-four-bottom display-table" style="">
                            <div class="display-table-cell-vertical-middle">
                                <a href="<?php echo e(route('trivia.entrada')); ?>" class="inner-link"><img src="<?php echo e(asset('images/logo-white.png')); ?>" data-img-size="(W)163px X (H)40px" alt="" style="border-radius: 0px; border-color: rgb(78, 78, 78); border-style: none; border-width: 1px !important;"></a>
                            </div>
                        </div>
                        <!-- end caption -->
                        <!-- caption -->
...
function validarPregunta(idRespuesta,idPregunta,idPreguntaCliente){
    ...
    console.log("segundos: "+segundos);
        ...
        $.ajax({
            url: "<?php echo e(route('trivia.validar')); ?>",
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false
            ...
            //if (data.success){
               ...
               /* $( document ).ready(function() {
                ...
                document.location="<?php echo e(route('trivia.front')); ?>";
            //}
...
</html><?php /**PATH /home/desafio/public_html/trivia/resources/views/layouts/front_trivia.blade.php ENDPATH**/ ?>