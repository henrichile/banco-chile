...
<html lang="en">
   <head>
      ...
      <link href="<?php echo e(asset('css/base.css')); ?>" rel="stylesheet" type="text/css" media="all"/>
      <link href="<?php echo e(asset('css/main.css')); ?>" rel="stylesheet" type="text/css" media="all"/>
      <link href="<?php echo e(asset('css/flexslider.css')); ?>" rel="stylesheet" type="text/css"  media="all" />
      <link href="<?php echo e(asset('css/magnific-popup.css')); ?>" rel="stylesheet" type="text/css"  media="all" />
      <link href="<?php echo e(asset('css/fonts.css')); ?>" rel="stylesheet" type="text/css"  media="all" />
      <link href="<?php echo e(asset('css/datepicker.css')); ?>" rel="stylesheet" type="text/css"  media="all" />
               ...
               <div class=" left-part">
                  <a class="logo scroll" href="#wrapper">
                     <h2 class="mb-0 mt-2 uppercase">
                        <img src="<?php echo e(asset('img/logo-bch.png')); ?>" width="200" >
                     </h2>
                  </a>
               </div>
        ...
        console.log("entro rut");
            ...
            if(indice==0){
               ...
               rut =$("#rut").focus();
                  ...
                  $("#error_rut"+indice).show();
                  rut =$("#rut"+indice).focus();
...
function validarTerminos(){
    if( $('#terminos').prop('checked') ) {
      ...
      function traeintegrantes(){
        ...
        $.ajax({
              type: "POST",
              url:  "<?php echo e(route('integrantes.agregar')); ?>",
              data: formData,
              contentType: false,
              processData: false, 
...
<?php /**PATH /home/banco/public_html/banco/resources/views/layouts/frontRegistro.blade.php ENDPATH**/ ?>