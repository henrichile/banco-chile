                        ...
                        <table id="listados" class="table table-borderless table-hover table-nowrap table-centered m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e($jurado[0]->name ?? 'S/Datos'); ?>

                                    </td>
                                        
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <td>
                                        <?php echo e(number_format($promedio,'2','.',',')); ?>
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Usuarios'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banco/public_html/banco/resources/views/clasificados.blade.php ENDPATH**/ ?>