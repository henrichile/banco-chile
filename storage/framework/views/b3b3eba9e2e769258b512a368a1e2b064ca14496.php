...
<tbody>
    ...
    <tr><td><?php echo e($i); ?></td><td><?php echo e($item['area']); ?></td><td><?php echo e(number_format($item['70'],'2',',','.')); ?></td><td><?php echo e(number_format($item['30'],'2',',','.')); ?></td><td><?php echo e(number_format($item['puntos'],'2',',','.')." %"); ?></td></tr>
    <?php
        $i++;
    ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/desafio/public_html/trivia/resources/views/ranking_area2.blade.php ENDPATH**/ ?>