...
<html lang="en">
   ...
   <body>
               ...
               <ul class="slides">
                  <li>
                     <div class="background-img overlay zoom">
                        <img src="<?php echo e(asset('img/bg1.jpg')); ?>" alt="">
                     </div>
                     <!--Container-->
                  ...
                  <li>
                     <div class="background-img overlay zoom">
                        <img src="<?php echo e(asset('img/bg2.jpg')); ?>" alt="">
                     </div>
                     <!--Container-->
                     <div class="container hero-content">
                        <!--Row-->
      ...
      <script src="<?php echo e(asset('js/audio.min.js')); ?>" ></script>
...
<?php /**PATH /home/banco/public_html/banco/resources/views/layouts/front.blade.php ENDPATH**/ ?>