        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Artistas y bandas pre-selecionadas 
                        <?php
                        if($zona==1){
                            echo " Zona Norte";
                        }else if($zona==2){
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                            ...
                            <tbody>
                                ...
                                <?php
                                $idUser=auth()->user()->id; 
                                 $sqls = "select * from notasPreseleccion where idArtista=? and idUsuario=?";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="<?php echo e(route('evaluarSeleccionado',['idArtista'=>$item->id, 'zona' =>$zona])); ?>">
                                            <?php echo csrf_field(); ?>
                                            <div class="row">
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Usuarios'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banco/public_html/banco/resources/views/seleccionados.blade.php ENDPATH**/ ?>